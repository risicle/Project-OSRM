...
//		std::cout << std::endl;
	...
	inline void FindPhantomNodeForCoordinate(const _Coordinate & location, PhantomNode & result , unsigned osmWayID = 0 ) const {
		nodeHelpDesk->FindPhantomNodeForCoordinate(location, result , osmWayID);
	}
